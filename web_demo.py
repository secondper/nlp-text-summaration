...
# 加载权重的路径
weight_path = os.path.join(model_dir, 'bart_epoch_10.pt') 
...
# 搭建 Gradio 界面
# 这里定义页面的样式和交互
with gr.Blocks(title="新闻摘要智能生成系统", theme=gr.themes.Soft()) as demo:
    
    # 标题部分
    gr.Markdown("# 新闻摘要智能生成系统")
    # gr.Markdown("本系统基于 **OpenMOSS-Team/bart-base-chinese** 模型微调，能够根据新闻内容自动生成摘要。")
    gr.Markdown("""
                本系统基于 🤗 [OpenMOSS-Team/bart-base-chinese](https://huggingface.co/OpenMOSS-Team/bart-base-chinese) 模型微调。
                """)
